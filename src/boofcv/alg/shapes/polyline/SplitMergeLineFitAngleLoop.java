...
/**
 * Implementation of {@link SplitMergeLineFitAngle} for looped lists of points.  The beginning and end of the list are
...
public class SplitMergeLineFitAngleLoop extends SplitMergeLineFitAngle {
