...
/**
 * Implementation of {@link SplitMergeLineFitAngle} for lists in which the end points are not connected.
 *
 * @author Peter Abeles
 */
// TODO only check lines that changed for splitting
public class SplitMergeLineFitAngleSegment extends SplitMergeLineFitAngle {

	public SplitMergeLineFitAngleSegment(double toleranceSplit, double toleranceMerge, int maxIterations) {
